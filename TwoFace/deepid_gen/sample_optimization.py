...
from TwoFace.deepid_gen.load_data import *
...
def sgd_optimization_mnist(learning_rate=0.13, 
    ...
    while epoch < n_epochs:
        ...
        train_losses = [test_train_model(i) for i in range(n_train_batches)]
        valid_losses = [test_valid_model(i) for i in range(n_valid_batches)]
