...
from TwoFace.deepid_gen.layers import *
from TwoFace.deepid_gen.deepid_class import *
...
def deepid_generating(x, params_file, nkerns, n_hidden, acti_func=relu):
...
def deepid_generate(arrs):
    params_file    = settings.BASE_DIR+r'\TwoFace\deepid_gen\params_files'
    nkerns  = [20,40,60,80]
    n_hidden = 160
